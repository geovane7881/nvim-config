...
local on_attach = function(_, bufnr)
  ...
  buf_set_keymap('n', 'H', '<cmd>lua vim.diagnostic.open_float()<cr>', ns)
  buf_set_keymap('n', '<Leader>H', '<cmd>lua vim.lsp.buf.signature_help()<CR>', ns)
  buf_set_keymap('n', '<Leader>O', '<cmd>lua vim.lsp.buf.hover()<CR>', ns)
...
-- v14.19.0 (casa)
-- v14.15.0 (trabalho)
-- CURRENT_NODE_INSTALLED = /home/ge/.nvm/versions/node/v14.21.1

-- local languageServerPath = os.getenv("CURRENT_NODE_INSTALLED") .. "/lib/"
-- local cmd = {
--   os.getenv("CURRENT_NODE_INSTALLED") .. "/bin/node",
...
-- null_ls.setup({
--     root_dir = utils.root_pattern("package.json", "Makefile", ".git"),
